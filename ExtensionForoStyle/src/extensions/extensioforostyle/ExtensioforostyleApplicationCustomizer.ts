...
import * as strings from 'ExtensioforostyleApplicationCustomizerStrings';

const LOG_SOURCE: string = 'ExtensioforostyleApplicationCustomizer';
 ...
 */
export interface IExtensioforostyleApplicationCustomizerProperties {
  // This is an example; replace with your own property
  testMessage: string;
}

/** A Custom Action which can be run during execution of a Client Side Application */
export default class ExtensioforostyleApplicationCustomizer
  extends BaseApplicationCustomizer<IExtensioforostyleApplicationCustomizerProperties> {
